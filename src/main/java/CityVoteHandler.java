...
public class CityVoteHandler implements RequestHandler<SNSEvent, String> {
    ...
    private final static String DATABASE_ARN = "arn-of-database";

    private final static String SECRET_STORE_ARN = "arn-of-secret-store";

    private final static String ENDPOINT = "https://rds-data.us-east-1.amazonaws.com";
    ...
    public String handleRequest(SNSEvent event, Context context) {
        ...
        String message = String.format("Thank you for attending re:Invent 2018. " +
                "We’ve heard from %d others, who are also from %s (so far)!" , numOtherPeopleFromSameCity, city);
