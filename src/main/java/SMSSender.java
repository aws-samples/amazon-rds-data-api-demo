...
public class SMSSender {
    ...
    private final static String LONG_CODE = "provisioned-long-code";
    private final static String APPLICATION_ID = "pinpoint-application-id";


    public void sendMessage(String number, String messageText) {
        AmazonPinpoint amazonPinpoint = AmazonPinpointClient.builder().withRegion("us-east-1").build();
